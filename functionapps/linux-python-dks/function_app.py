...
def dks_product_scrape(req:func.HttpRequest):
    ...
    product_search_results = get_all_products_search('on')
    ...
    skus_inventory_df = get_inventory_data(skus_meta_df['sku_id'].to_list(), location_df['store_code'].astype(str).to_list())
